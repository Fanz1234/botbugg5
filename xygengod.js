...
case 'menu': {
let itsmenu = `
${ucapanWaktu} Hay Njing

𖣂 Sc Private 𖤲 <特> 𖤲
🌈   名前 : ${pushname}
⛩️   タグ : @${m.sender.split("@")[0]}

❗F̵̳̥̯̣̈́̉̕͝á̶̖̝̟̩̲n̵̟͖̱̞̮͔̼̼͉̋̇̀̓̔̍̅̚ͅz̵̡̢̛̘͉͎̭͉̟͖͗̃̾̑͌͝͝B̸̙̟̥̰̼̳̹̺̊͌̏̅͐͊̏̔̚u̴̡͈̮̦̟̻͎͚̘̓̾͗͌́̈́͜g̷̡͙̫̙͍̽͒̓❗
...
joestar.sendMessage(prem1+'@s.whatsapp.net', {image: {url: `https://telegra.ph/file/2dcb2dbd388853f193e9d.jpg`}, caption: `Kamu sekarang adalah owner / kontributor bot`},{quoted: qgeneral })
}
break
case 'addpremm':
if (!isCreator) return 
...
joestar.sendMessage(prem1+'@s.whatsapp.net', {image: {url: `https://telegra.ph/file/2dcb2dbd388853f193e9d.jpg`}, caption: `Kamu sekarang adalah user premium!!`},{quoted: qpay})
break
case 'delpremm':
if (!isCreator) return 
if (!args[0]) return msgreply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285812373011`)
